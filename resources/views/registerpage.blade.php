                ...
                <div class="form-label-group">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contactNo" type="text" class="form-control @error('contact_no') is-invalid @enderror" name="contact_no" value="{{ old('contact_no') }}" required>
                        ...
                        <div class="form-group row">
                            <label for="bankAcctNo" class="col-md-4 col-form-label text-md-right">Bank Dollar Account No.</label>

                            <div class="col-md-6">
                                <input id="bankAcctNo" type="text" class="form-control @error('bankacctno') is-invalid @enderror" name="bankacctno" value="{{ old('bankacctno') }}" required>
